...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Phase 1: UCB Score Calculation Training")
    parser.add_argument("--data_dir", type=str, default="/data/patches/", help="Directory with H5 patch files.")
    parser.add_argument("--output_dir", type=str, default="./results/ucb_phase1", help="Directory to save checkpoints and results.")
    parser.add_argument("--run_name", type=str, default="vit-ucb-phase1", help="Name for the WandB run.")
