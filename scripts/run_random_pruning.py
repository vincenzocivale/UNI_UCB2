...
def main(args):
    ...
    model = VisionTransformerUCB(
        ...
        keep_ratio=args.training_keep_ratio,
        exclude_cls=True,
    ...
    print("--- Random Pruning Training Finished ---")
    print(f"Best model checkpoint saved to {trainer.state.best_model_checkpoint}")


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Training with Random Patch Selection.")
    parser.add_argument("--data_dir", type=str, default="/data/patches/", help="Directory with H5 patch files.")
    parser.add_argument("--output_dir", type=str, default="./results/random_pruning", help="Directory to save checkpoints and results.")
    parser.add_argument("--run_name", type=str, default="vit-random-pruning", help="Name for the WandB run.")
    ...
    parser.add_argument("--training_keep_ratio", type=float, default=0.3, help="Keep ratio for UCB training.")
    parser.add_argument("--selection_mode", type=str, default="random", choices=['ucb', 'random'], help="Pruning selection mode.")
